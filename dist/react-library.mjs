...
function he() {
  ...
  return p.Fragment = _, p.jsx = R, p.jsxs = R, p;
}
var h = {};
/**
 * @license React
...
var ke = Ce();
const Se = ({ label: s, onClick: _ }) => /* @__PURE__ */ ke.jsx("button", { onClick: _, className: "px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700", children: s });
export {
  Se as Button
};
